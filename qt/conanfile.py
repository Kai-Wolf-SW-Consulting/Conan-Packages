...
class QtConan(ConanFile):
    ...
    homepage = "http://download.qt.io/official_releases/qt"
    ...
    default_options = ("shared=True", "fPIC=True", "opengl=desktop", "openssl=no") + tuple(
        module[2:] + "=True" if module in ["qtxmlpatterns", "qttools"] else module[2:] + "=False"
    ...
    def source(self):
        url = self.homepage + "/{0}/{1}/single/qt-everywhere-src-{1}"\
